      ...
      <div className="divBody">
        <div className="divTarjetaTransfondo">
          ...
          <p>
            ...
            Servir a los dioses y descubrir sus obras sagradas te guiarán hacia
            la grandeza.
          </p>
          <p>Habilidades: Perspicacia y religión</p>
        </div>
        <div className="divTarjetaTransfondo">
          <h2>CHARLATÁN</h2>
          ...
          <p>
            ...
            aliados unos contra otros te llevará a un mayor éxito en el futuro.
          </p>
          <p>Habilidades: Engaño y juego de manos</p>
        </div>
        <div className="divTarjetaTransfondo">
          <h2>CRIMINAL</h2>
          ...
          <p>
            ...
            delictiva te dará mayores oportunidades en el futuro.
          </p>
          <p>Habilidades: Engaño y sigilo</p>
        </div>
        <div className="divTarjetaTransfondo">
          <h2>ARTISTA</h2>
          ...
          <p>
            ...
            desventurados y oprimidos aumenta tu aura carismática.
          </p>
          <p>Habilidades: Acrobacias y actuar</p>
        </div>
        <div className="divTarjetaTransfondo">
          ...
          <p>
            ...
            inminente hará crecer tu leyenda.
          </p>
          <p>Habilidades: Trato con animales y supervivencia</p>
        </div>
        <div className="divTarjetaTransfondo">
          ...
          <p>
            ...
            dedicas a tu arte. Reparar y descubrir artesanías raras te traerá
        ...
        <div className="divTarjetaTransfondo">
          ...
          <p>Habilidades: Historia y persuasión</p>
        </div>
        <div className="divTarjetaTransfondo">
          <h2>NÓMADA</h2>
          ...
          <p>
            ...
            de la naturaleza aumentará tu destreza y comprensión.
          </p>
          <p>Habilidades: Atletismo y supervivencia</p>
        </div>
        <div className="divTarjetaTransfondo">
          <h2>SABIO</h2>
          ...
          <p>
            ...
            poner este conocimiento al servicio de un propósito mayor.
          </p>
          <p>Habilidades: Arcana y historia</p>
        </div>
        <div className="divTarjetaTransfondo">
          <h2>SOLDADO</h2>
          ...
          <p>
            ...
            oficiales. Demuestra tácticas inteligentes y valentía en el campo de
            batalla para mejorar tu destreza.
          </p>
          <p>Habilidades: Atletismo y intimidación</p>
        </div>
        <div className="divTarjetaTransfondo">
          <h2>HUERFANO</h2>
          ...
          <p>
            ...
            tu espíritu para el viaje que tienes por delante.
          </p>
          <p>Habilidades: Juego de manos y sigilo</p>
        </div>
      </div>
    </>
  );
